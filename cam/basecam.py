...
from utils import find_alexnet_layer, find_vgg_layer, find_resnet_layer, find_densenet_layer, \
    find_squeezenet_layer, find_layer, find_googlenet_layer, find_mobilenet_layer, find_shufflenet_layer, find_mynet_layer
...
class BaseCAM(object):
    ...
    def __init__(self, model_dict):
        ...
        elif 'mynet' in model_type.lower():
            self.target_layer = find_mynet_layer(self.model_arch, layer_name)
        else:
