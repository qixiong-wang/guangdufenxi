...
mynet =  Baseline(input_channels=2, n_classes=2,dropout=True)
model_dir = './checkpoints/CNN_model/choosed_data/bestmodel.pth'
...
with open(test_txt_path) as f:
    for line in f.readlines():
        ...
        input_data = torch.from_numpy(processed_data).unsqueeze(0)
        ...
        png_save_path = os.path.join(visualization_dir, line.split(' ')[0])+'_'+str(label)
